(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        const itemsForMore = document.querySelectorAll(".results-search-block__item.hidden");
        const itemsForMore2 = document.querySelectorAll(".item-content-news.hidden");
        const itemsForMore3 = document.querySelectorAll(".bottom-comments-news__level-1.hidden");
        if (btnMore) btnMore.addEventListener("click", (() => {
            ...
            if (itemsForMore2) for (let i = 0; i < itemsForMore2.length; i++) {
                itemsForMore2[i].classList.remove("hidden");
                btnMore.classList.add("hidden");
            }
            if (itemsForMore3) for (let i = 0; i < itemsForMore3.length; i++) {
                itemsForMore3[i].classList.remove("hidden");
                btnMore.classList.add("hidden");
            }
        }));
